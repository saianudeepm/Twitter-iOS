...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:myTableCell bundle:nil] forCellReuseIdentifier:myTableCell];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    TweetCell *cell = [self.tableView dequeueReusableCellWithIdentifier:myTableCell];
...
- (TweetCell *)protoTypeCell {
    ...
    if (!_protoTypeCell) {
        _protoTypeCell = [self.tableView dequeueReusableCellWithIdentifier:myTableCell];
    }
